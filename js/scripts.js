 ...
 */
class Product {
    constructor(id, title, price, image,rating) {
        this.id = id;
...
let peanut = new Product(6, "Peanuts", 14.05, "/assets/products/Peanuts.jpeg",5);
...
const loadProducts = () => {
    ...
    <div class="card h-100">
        ...
        <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
            <div class="text-center"><button id="${'cart_'+product.id}" class="add-cart btn btn-outline-dark mt-auto" >Add to cart</button></div>
        </div>
    </div>
</div>`
   });
